const translations = {
    es: {
        ...
        btn_edit: "Editar",
        btn_delete: "Eliminar",
        msg_delete_title: "¿Eliminar registro?",
        msg_delete_text: "Esta acción no se puede deshacer.",
        msg_deleted: "Registro eliminado",
        msg_edit_success: "Registro actualizado",
    ...
    pt: {
        ...
        btn_edit: "Editar",
        btn_delete: "Excluir",
        msg_delete_title: "Excluir registro?",
        msg_delete_text: "Esta ação não pode ser desfeita.",
        msg_deleted: "Registro excluído",
        msg_edit_success: "Registro atualizado",
        title_edit: "Editar Registro",
        btn_cancel: "Cancelar",
        btn_save: "Salvar",
